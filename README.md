...
<img src=".github/github.png" align="top" width="20" /> [FSearch](https://github.com/cboxdoerfer/fsearch) (`fsearch`) - <i>A fast file search utility, inspired by Everything Search Engine. It's written in C and based on GTK3.</i><br />
